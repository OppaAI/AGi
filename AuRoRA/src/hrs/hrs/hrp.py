...
class AGi:                               # Amazing Grace infrastructure
    ...
    class CNS:                           # Central Nervous System
        ...
        class EMC:                       # Episodic Memory Cortex
            ...
            ENCODING_CACHE_LIMIT   = 256 # [INTRINSIC] Maximum number of imprints held in encoding cache to control memory usage
            ENCODING_IMPRINT_LIMIT = 300 # [INTRINSIC] Maximum length of imprints to control cache hit rate vs false positive risk
