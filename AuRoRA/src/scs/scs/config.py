...
AGi — Configuration
======================
Central config for all AGi systems.
...
# ─── Identity ───────────────────────────────────────────────────────────
BIRTH_DATE = date(2026, 1, 1)   # adjust to actual birth date

# ─── Memory ──────────────────────────────────────────────────────────────────
DB_PATH      = ".grace/grace_memory.db"   # relative to home dir
CHAT_HISTORY_FILE  = ".grace/chat_history.json"
REFLECTIONS_FILE   = ".grace/reflections.json"
COUNT_FILE   = ".grace/today_count.json"
